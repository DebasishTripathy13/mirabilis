...
from . import hub, measure, registry, server, tune
...
def cmd_pull(args) -> int:
    ...
    if args.quant:
        ...
        chosen = hub.choose_quant(quants, budget)
        if chosen is None:
            smallest = quants[0]
            print(yellow(
